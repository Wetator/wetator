  ...
  public static String escapeIdent(final String aString) {
    ...
    while (i < tmpLength) {
      ...
      if (tmpChar == 0) {
        ...
        i++;
        break;
      } else if (tmpChar >= 0x0080 || tmpChar == 0x002D || tmpChar == 0x005F
          || (tmpChar >= 0x0030 && tmpChar <= 0x0039) || (tmpChar >= 0x0041 && tmpChar <= 0x005A)
          || (tmpChar >= 0x0061 && tmpChar <= 0x007a)) {
    ...
    while (i < tmpLength) {
      ...
      if (tmpChar == 0) {
        ...
        // [A-Z] (U+0041 to U+005A), or \[a-z] (U+0061 to U+007A), then the character itself.
        if (tmpEscaped
            && ((tmpChar >= 0x0030 && tmpChar <= 0x0039) || (tmpChar >= 0x0041 && tmpChar <= 0x0046) || (tmpChar >= 0x0061 && tmpChar <= 0x0066))) {
          tmpResult.append(' ');
        }
