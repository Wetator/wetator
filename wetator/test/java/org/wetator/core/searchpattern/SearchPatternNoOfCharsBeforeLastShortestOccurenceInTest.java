 ...
 * @author frank.danek
 */
public class SearchPatternNoOfCharsBeforeLastShortestOccurenceInTest {
  ...
  public void nullText() {
    ...
    Assert.assertEquals(-1, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
  ...
  public void emptyText() {
    ...
    // match all
    SearchPattern tmpPattern = SearchPattern.compile((String) null);
    Assert.assertEquals(0, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("");
    Assert.assertEquals(0, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("*");
    Assert.assertEquals(0, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
  ...
  public void oneCharText() {
    ...
    // regexp
    tmpPattern = SearchPattern.compile("?");
    Assert.assertEquals(tmpText.length() - 1, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("f?");
    Assert.assertEquals(-1, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("?x");
    Assert.assertEquals(-1, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
  ...
  public void multipleCharText() {
    ...
    // match all
    SearchPattern tmpPattern = SearchPattern.compile((String) null);
    Assert.assertEquals(tmpText.length(), tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("");
    Assert.assertEquals(tmpText.length(), tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("*");
    Assert.assertEquals(tmpText.length(), tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    ...
    Assert.assertEquals(4, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("We");
    Assert.assertEquals(0, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("tor");
    Assert.assertEquals(4, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("tato");
    Assert.assertEquals(2, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    ...
    Assert.assertEquals(4, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("?t");
    Assert.assertEquals(3, tmpPattern.noOfCharsBeforeLastShortestOccurenceIn(tmpText));
