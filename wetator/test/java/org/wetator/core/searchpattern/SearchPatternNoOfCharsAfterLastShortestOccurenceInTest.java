 ...
 * @author frank.danek
 */
public class SearchPatternNoOfCharsAfterLastShortestOccurenceInTest {
  ...
  public void multipleCharText() {
    ...
    Assert.assertEquals(2, tmpPattern.noOfCharsAfterLastShortestOccurenceIn(tmpText));
    tmpPattern = SearchPattern.compile("We");
    Assert.assertEquals(5, tmpPattern.noOfCharsAfterLastShortestOccurenceIn(tmpText));
