...
public class ByAriaLabelAttributeMatcherTest extends AbstractMatcherTest {
  ...
  public void not() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        + "<button id='myId' name='myName' aria-label='text'>X</button>"
        + "</body></html>";
    // @formatter:on
  ...
  public void full() throws IOException, InvalidInputException {
    // @formatter:off
    final String tmpHtmlCode = "<html><body>"
        + "<button id='myId' aria-label='myName'>X</button>"
        + "</body></html>";
    // @formatter:on
    ...
    assertMatchEquals("myId", FoundType.BY_ARIA_LABEL_ATTRIBUTE, 0, 0, 0, tmpMatches.get(0));
  }
  ...
  public void part() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(1, tmpMatches.size());
    assertMatchEquals("myId", FoundType.BY_ARIA_LABEL_ATTRIBUTE, 2, 0, 0, tmpMatches.get(0));
  }
  ...
  public void full_TextBefore() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(1, tmpMatches.size());
    assertMatchEquals("myId", FoundType.BY_ARIA_LABEL_ATTRIBUTE, 0, 5, 14, tmpMatches.get(0));
  }
  ...
  public void part_TextBefore() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(1, tmpMatches.size());
    assertMatchEquals("myId", FoundType.BY_ARIA_LABEL_ATTRIBUTE, 2, 5, 14, tmpMatches.get(0));
  }
