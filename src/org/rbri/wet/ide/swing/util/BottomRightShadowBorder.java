...
public class BottomRightShadowBorder extends AbstractBorder {
    ...
    public void paintBorder(Component aComponent, Graphics aGraphics, int x, int y, int aWidth, int aHeight) {
        ...
        Color tmpLightShadowColor = new Color(tmpShadowColor.getRed(), tmpShadowColor.getGreen(), tmpShadowColor.getBlue(), 170);
        Color tmpLighterShadowColor = new Color(tmpShadowColor.getRed(), tmpShadowColor.getGreen(), tmpShadowColor.getBlue(), 70);
