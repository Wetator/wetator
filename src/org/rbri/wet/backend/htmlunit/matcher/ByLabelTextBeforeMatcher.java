...
public class ByLabelTextBeforeMatcher extends AbstractByAttributeMatcher {
   ...
   */
  public ByLabelTextBeforeMatcher(DomNodeText aDomNodeText, SearchPattern aPathSearchPattern, FindSpot aPathSpot,
  ...
  protected String getAttributeValue(HtmlElement aHtmlElement) {
    return domNodeText.getLabelTextBefore(aHtmlElement, pathSpot.endPos);
  }

  /**
   * {@inheritDoc}
   * 
   * @see org.rbri.wet.backend.htmlunit.matcher.AbstractByAttributeMatcher#processTextForDistance(java.lang.String)
   */
  @Override
