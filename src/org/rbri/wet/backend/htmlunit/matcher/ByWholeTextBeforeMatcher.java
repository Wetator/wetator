...
public class ByWholeTextBeforeMatcher extends AbstractByAttributeMatcher {
   ...
   */
  public ByWholeTextBeforeMatcher(DomNodeText aDomNodeText, SearchPattern aPathSearchPattern, FindSpot aPathSpot,
      SearchPattern aSearchPattern, WeightedControlList aFoundElements) {
    super(aDomNodeText, aPathSearchPattern, aPathSpot, aSearchPattern, aFoundElements, FoundType.BY_TEXT);
  ...
  protected String getAttributeValue(HtmlElement aHtmlElement) {
    return domNodeText.getTextBefore(aHtmlElement);
  }
}
