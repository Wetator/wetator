 ...
 * @author frank.danek
 */
public class ByNameAttributeMatcher extends AbstractByAttributeMatcher {
   ...
   */
  public ByNameAttributeMatcher(DomNodeText aDomNodeText, SearchPattern aPathSearchPattern, FindSpot aPathSpot,
      SearchPattern aSearchPattern, WeightedControlList aFoundElements) {
    super(aDomNodeText, aPathSearchPattern, aPathSpot, aSearchPattern, aFoundElements, FoundType.BY_NAME);
  ...
  protected String getAttributeValue(HtmlElement aHtmlElement) {
    return aHtmlElement.getAttribute("name");
  }
}
