...
public class ByLabelTextAfterMatcher extends AbstractByAttributeMatcher {
   ...
   */
  public ByLabelTextAfterMatcher(DomNodeText aDomNodeText, SearchPattern aPathSearchPattern, FindSpot aPathSpot,
  ...
  protected String getAttributeValue(HtmlElement aHtmlElement) {
    return domNodeText.getLabelTextAfter(aHtmlElement);
  }
}
