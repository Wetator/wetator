...
/**
 * This matcher checks if the attribute 'label' of the given element matches the criteria.
 * 
 * @author frank.danek
 */
public class ByLabelAttributeMatcher extends AbstractByAttributeMatcher {
   ...
   */
  public ByLabelAttributeMatcher(DomNodeText aDomNodeText, SearchPattern aPathSearchPattern, FindSpot aPathSpot,
      SearchPattern aSearchPattern, WeightedControlList aFoundElements) {
    super(aDomNodeText, aPathSearchPattern, aPathSpot, aSearchPattern, aFoundElements, FoundType.BY_LABEL_TEXT);
  }
  ...
  protected String getAttributeValue(HtmlElement aHtmlElement) {
    return aHtmlElement.getAttribute("label");
  }
}
