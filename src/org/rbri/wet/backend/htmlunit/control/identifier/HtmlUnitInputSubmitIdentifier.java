 ...
 * @author frank.danek
 */
public class HtmlUnitInputSubmitIdentifier extends AbstractHtmlUnitControlIdentifier {
  ...
  public void identify(List<SecretString> aSearch, HtmlElement aHtmlElement) {
    ...
    for (MatchResult tmpMatch : tmpMatches) {
      foundControls.add(new HtmlUnitInputSubmit((HtmlSubmitInput) tmpMatch.getHtmlElement()), tmpMatch.getFoundType(),
