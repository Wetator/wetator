...
public class HtmlUnitInputFileIdentifierTest extends AbstractHtmlUnitControlIdentifierTest {
  ...
  public void byId() throws IOException, InvalidInputException {
    ...
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_ID deviation: 0 distance: 0 start: 0 hierarchy: 0>1>3>4>5 index: 5",
  ...
  public void byDataTestid() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        + "<form action='test'>"
        + "<input id='myId' name='myName' type='file' data-testid='myDataTestId'>"
        + "</form>"
        + "</body></html>";
    // @formatter:on
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName') (data-testid='myDataTestId')] found by: BY_DATE_TESTID deviation: 0 distance: 0 start: 0 hierarchy: 0>1>3>4>5 index: 5",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byName() throws IOException, InvalidInputException {
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_NAME deviation: 0 distance: 0 start: 0 hierarchy: 0>1>3>4>5 index: 5",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byIdName() throws IOException, InvalidInputException {
    ...
    final List<Entry> tmpEntriesSorted = identify(tmpHtmlCode, "FileInput", "FileInput");

    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='FileInput') (name='FileInput')] found by: BY_ID deviation: 0 distance: 0 start: 0 hierarchy: 0>1>3>4>5 index: 5",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byLabelingTextBefore() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        + "<form action='test'>"
        + "<input id='otherId1' name='otherName1' type='file'>"
        + "<p>Marker</p>"
        + "<input id='myId' name='myName' type='file'>"
        + "<p>Some text ...</p>"
        + "<input id='otherId2' name='otherName2' type='file'>"
        + "</form>"
        + "</body></html>";
    // @formatter:on
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_LABELING_TEXT deviation: 0 distance: 0 start: 6 hierarchy: 0>1>3>4>8 index: 8",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byHtmlLabel_text() throws IOException, InvalidInputException {
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_LABEL_ELEMENT deviation: 0 distance: 0 start: 6 hierarchy: 0>1>3>4>7 index: 7",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byHtmlLabel_text_invisible() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        + "<form action='test'>"
        + "<label id='labelId' for='myId'>Marker</label>"
        + "<input id='myId' name='myName' type='file' style='display: none;'>"
        + "</form>"
        + "</body></html>";
    // @formatter:on
  ...
  public void byHtmlLabelChild_text() throws IOException, InvalidInputException {
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_LABEL_ELEMENT deviation: 0 distance: 0 start: 6 hierarchy: 0>1>3>4>5>7 index: 7",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byLabelingTextBeforeAsText_wildcardOnly() throws IOException, InvalidInputException {
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId') (name='myName')] found by: BY_TEXT deviation: 0 distance: 0 start: 6 hierarchy: 0>1>3>4>8 index: 8",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void byTableCoordinates() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        ...
        + "          <td id='cell_1_2'><input id='myId_1_2' type='file'></td>"
        + "          <td id='cell_1_3'><input id='myId_1_3' type='file'></td>"
        + "        </tr>"
        + "        <tr>"
        + "          <td id='cell_2_1'>row_2</td>"
        + "          <td id='cell_2_2'><input id='myId_2_2' type='file'></td>"
        + "          <td id='cell_2_3'><input id='myId_2_3' type='file'></td>"
        + "        </tr>"
        + "      </tbody>"
        + "    </table>"
        + "</body></html>";
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId_2_3')] found by: BY_TABLE_COORDINATE deviation: 0 distance: 38 start: 38 hierarchy: 0>1>3>5>22>36>44>45 index: 45",
        tmpEntriesSorted.get(0).toString());
  }
  ...
  public void inTable() throws IOException, InvalidInputException {
    ...
    final String tmpHtmlCode = "<html><body>"
        ...
        + "        <tr>"
        + "          <td id='cell_1_1'>row_1</td>"
        + "          <td id='cell_1_2'>Marker <input id='myId_1_2' type='file'></td>"
        + "          <td id='cell_1_3'>Marker <input id='myId_1_3' type='file'></td>"
        + "        </tr>"
        + "        <tr>"
        + "          <td id='cell_2_1'>row_2</td>"
        + "          <td id='cell_2_2'>Marker <input id='myId_2_2' type='file'></td>"
        + "          <td id='cell_2_3'>Marker <input id='myId_2_3' type='file'></td>"
        + "        </tr>"
        + "      </tbody>"
        + "    </table>"
        + "</body></html>";
    ...
    assertEquals(1, tmpEntriesSorted.size());
    assertEquals(
        "[HtmlFileInput (id='myId_2_3')] found by: BY_LABELING_TEXT deviation: 0 distance: 60 start: 66 hierarchy: 0>1>3>5>22>38>47>49 index: 49",
        tmpEntriesSorted.get(0).toString());
  }
}