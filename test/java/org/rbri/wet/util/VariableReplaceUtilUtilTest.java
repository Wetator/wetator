...
public class VariableReplaceUtilUtilTest extends TestCase {
    ...
    public void testReplaceVariable_TwoVar_null() {
        ...
        assertEquals("a ${var0} b ${var1} c", VariableReplaceUtil.replaceVariables(tmpStringWithPlaceholders, tmpVariables, false));
    }
    ...
    public void testReplaceVariable_ReusedVars() {
        ...
        assertEquals("value0value1 value0", VariableReplaceUtil.replaceVariables(tmpStringWithPlaceholders, tmpVariables, false));
    }
