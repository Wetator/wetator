 ...
 * @author frank.danek
 */
public class ByTitleAttributeMatcherTest extends AbstractMatcherTest {
  ...
  public void full() throws IOException, InvalidInputException {
    ...
    assertMatchEquals("myId", FoundType.BY_TITLE_ATTRIBUTE, 0, 14, 14, tmpMatches.get(0));
  }
  ...
  public void part() throws IOException, InvalidInputException {
    ...
    assertEquals(1, tmpMatches.size());
    assertMatchEquals("myId", FoundType.BY_TITLE_ATTRIBUTE, 2, 14, 14, tmpMatches.get(0));
  }
