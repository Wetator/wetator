...
public class HtmlUnitInputButtonIdentifierTest extends AbstractHtmlUnitControlIdentifierTest {
  ...
  public void byId() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'ClickMe' (id='myId')] found by: BY_ID deviation: 0 distance: 0 start: 0 index: 5",
  ...
  public void byName() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'ClickMe' (id='myId') (name='MyName')] found by: BY_NAME deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byValue() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'ClickMe' (id='myId')] found by: BY_LABELING_TEXT deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byIdNameValue() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'MyName' (id='MyName') (name='MyName')] found by: BY_ID deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byTableCoordinates() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'Click' (id='InputButton_2_3')] found by: BY_TABLE_COORDINATE deviation: 0 distance: 56 start: 56 index: 45",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void inTable() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButtonInput 'Click' (id='InputButton_2_3')] found by: BY_LABELING_TEXT deviation: 0 distance: 56 start: 56 index: 45",
        tmpFound.getEntriesSorted().get(0).toString());
  }
}
