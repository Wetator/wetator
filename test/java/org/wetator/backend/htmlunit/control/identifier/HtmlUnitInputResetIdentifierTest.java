...
public class HtmlUnitInputResetIdentifierTest extends AbstractHtmlUnitControlIdentifierTest {
  ...
  public void byIdWildcard() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals("[HtmlResetInput 'ClickMe' (id='myId')] found by: BY_ID coverage: 2 distance: 0 start: 0",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byId_TextBefore() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals("[HtmlResetInput 'ClickMeAlso' (id='myId')] found by: BY_ID coverage: 0 distance: 0 start: 14",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byNameWildcard() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlResetInput 'ClickMe' (id='myId') (name='MyName')] found by: BY_NAME coverage: 2 distance: 0 start: 0",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byName_TextBefore() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlResetInput 'ClickMe' (id='myId') (name='MyName')] found by: BY_NAME coverage: 0 distance: 5 start: 14",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byTextWildcard() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlResetInput 'ClickMe' (id='myId')] found by: BY_LABEL_TEXT coverage: 2 distance: 0 start: 0", tmpFound
            .getEntriesSorted().get(0).toString());
  }
  ...
  public void byText_TextBefore() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlResetInput 'ClickMe' (id='myId')] found by: BY_LABEL_TEXT coverage: 0 distance: 5 start: 14", tmpFound
            .getEntriesSorted().get(0).toString());
  }
