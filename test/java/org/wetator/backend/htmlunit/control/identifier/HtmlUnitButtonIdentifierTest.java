...
public class HtmlUnitButtonIdentifierTest extends AbstractHtmlUnitControlIdentifierTest {
  ...
  public void byText() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButton 'ButtonWithText' (id='myId') (name='MyName')] found by: BY_LABELING_TEXT coverage: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byInnerImage_Alt() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlButton 'image: picture.png' (id='myId') (name='MyName')] found by: BY_LABELING_TEXT coverage: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
