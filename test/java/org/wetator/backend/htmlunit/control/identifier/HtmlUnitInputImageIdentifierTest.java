...
public class HtmlUnitInputImageIdentifierTest extends AbstractHtmlUnitControlIdentifierTest {
  ...
  public void byId() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId') (name='MyName')] found by: BY_ID deviation: 0 distance: 0 start: 0 index: 5",
  ...
  public void byName() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId') (name='MyName')] found by: BY_NAME deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byImageAlt() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId') (name='MyName')] found by: BY_IMG_ALT_ATTRIBUTE deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byImageTitle() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId') (name='MyName')] found by: BY_IMG_TITLE_ATTRIBUTE deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byImageSrc() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId') (name='MyName')] found by: BY_IMG_SRC_ATTRIBUTE deviation: 23 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byIdNameAltTitleSrc() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/MyName') (id='MyName') (name='MyName')] found by: BY_ID deviation: 0 distance: 0 start: 0 index: 5",
        tmpFound.getEntriesSorted().get(0).toString());
  }
  ...
  public void byTableCoordinates() throws IOException, InvalidInputException {
    ...
    Assert.assertEquals(
        "[HtmlImageInput '' (src='http://www.wetator.org/picture.png') (id='myId_2_3')] found by: BY_TABLE_COORDINATE deviation: 0 distance: 38 start: 38 index: 45",
        tmpFound.getEntriesSorted().get(0).toString());
  }
}
