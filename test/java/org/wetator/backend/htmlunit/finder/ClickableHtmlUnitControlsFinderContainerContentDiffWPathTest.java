 ...
 *
 * @author tobwoerk
 * @see ClickableHtmlUnitControlsFinderContainerContentEqWPathTest check sister test class for structured suite that
 *      leads to
 *      these test cases
 */
public class ClickableHtmlUnitControlsFinderContainerContentDiffWPathTest
