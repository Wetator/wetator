...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" version="1.0">
    ...
    <xsl:variable name="browserPicture.Edge">resources/browser-edge.png</xsl:variable>
                ...
                <xsl:if test="$browserCount > 1">
                    <table align="center" cellpadding="4" cellspacing="0" border="0" style="margin-top: 25px">
                        <tr>
                                ...
                                <td>
                                    ...
                                    <img src="resources/expand-square.png" alt="show/hide all browser overviews" class="expandCollapse">
                                        <xsl:attribute name="onclick">
                                            ...
                                            <xsl:if test="/wet/testcase/testrun/@browser='Firefox'">, 'ff','ffoverview'</xsl:if>
                                            <xsl:if test="/wet/testcase/testrun/@browser='FirefoxESR'">, 'ffesr','ffesroverview'</xsl:if>
                                            <xsl:if test="/wet/testcase/testrun/@browser='Chrome'">, 'chrome','chromeoverview'</xsl:if>
                                            <xsl:if test="/wet/testcase/testrun/@browser='Edge'">, 'edge','edgeoverview'</xsl:if>
                                            <xsl:text>)</xsl:text>
                                        </xsl:attribute>
                                    </img>
                                </td>
                            <xsl:if test="/wet/testcase/testrun/@browser='Firefox'">
                                <td>
                                    <span class="bold">FF</span>
                                    <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                    <img id="ff" src="resources/expand-square.png" onclick="showOrHide(this, 'ffoverview')" alt="show/hide FF overview" class="expandCollapse"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="/wet/testcase/testrun/@browser='FirefoxESR'">
                                <td>
                                    <span class="bold">FF ESR</span>
                                    <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                    <img id="ffesr" src="resources/expand-square.png" onclick="showOrHide(this, 'ffesroverview')" alt="show/hide FF ESR overview" class="expandCollapse"/>
                                </td>
                            </xsl:if>
                            ...
                            <xsl:if test="/wet/testcase/testrun/@browser='EDGE'">
                                <td>
                                    <span class="bold">Edge</span>
                                    <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                    <img id="edge" src="resources/expand-square.png" onclick="showOrHide(this, 'edgeoverview')" alt="show/hide Edge overview" class="expandCollapse"/>
                                </td>
                            </xsl:if>
                        </tr>
                    </table>
                    ...
                    <xsl:if test="/wet/testcase/testrun/@browser='Firefox'">
                        <table id="ffoverview" class="overview" align="center" style="display: none; text-align: center;">
                            <xsl:variable name="failedFirefox" select="count(/wet/testcase/testrun[@browser='Firefox'][boolean(descendant::failure and not(error) and not(error) and not(descendant::command/error) and not(descendant::testfile/error))])"/>
                            <xsl:variable name="errorsFirefox" select="count(/wet/testcase/testrun[@browser='Firefox'][boolean(error or descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="ignoredFirefox" select="count(/wet/testcase/testrun[@browser='Firefox']/ignored)"/>
                            <xsl:variable name="stepsOkFirefox" select="count(/wet/testcase/testrun[@browser='Firefox']/testfile/command[not(@isComment) and not(descendant-or-self::failure) and not(descendant-or-self::error) and not(descendant-or-self::ignored)])"/>
                            <xsl:variable name="stepsFailureFirefox" select="count(/wet/testcase/testrun[@browser='Firefox']/testfile/command[(descendant-or-self::failure) and not(descendant::command/error)])"/>
                            <xsl:variable name="stepsErrorFirefox" select="count(/wet/testcase/testrun[@browser='Firefox']/testfile[boolean(descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="stepsIgnoredFirefox" select="count(/wet/testcase/testrun[@browser='Firefox']/testfile/command[(descendant-or-self::ignored) and not(descendant::failure) and not(descendant::command/error)])"/>
                            <xsl:call-template name="testBrowserOverview">
                                <xsl:with-param name="browserPicture" select="$browserPicture.Firefox"/>
                                <xsl:with-param name="browserName">FF</xsl:with-param>
                                <xsl:with-param name="browserTestFailureCount" select="$failedFirefox"/>
                                <xsl:with-param name="browserTestErrorCount" select="$errorsFirefox"/>
                                <xsl:with-param name="browserTestIgnoredCount" select="$ignoredFirefox"/>
                                <xsl:with-param name="browserStepsOkCount" select="$stepsOkFirefox"/>
                                <xsl:with-param name="browserStepsFailureCount" select="$stepsFailureFirefox"/>
                                <xsl:with-param name="browserStepsErrorCount" select="$stepsErrorFirefox"/>
                                <xsl:with-param name="browserStepsIgnoredCount" select="$stepsIgnoredFirefox"/>
                            </xsl:call-template>
                        </table>
                    </xsl:if>
                    <xsl:if test="/wet/testcase/testrun/@browser='FirefoxESR'">
                        <table id="ffesroverview" class="overview" align="center" style="display: none; text-align: center;">
                            <xsl:variable name="failedFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR'][boolean(descendant::failure and not(error) and not(error) and not(descendant::command/error) and not(descendant::testfile/error))])"/>
                            <xsl:variable name="errorsFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR'][boolean(error or descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="ignoredFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR']/ignored)"/>
                            <xsl:variable name="stepsOkFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR']/testfile/command[not(@isComment) and not(descendant-or-self::failure) and not(descendant-or-self::error) and not(descendant-or-self::ignored)])"/>
                            <xsl:variable name="stepsFailureFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR']/testfile/command[(descendant-or-self::failure) and not(descendant::command/error)])"/>
                            <xsl:variable name="stepsErrorFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR']/testfile[boolean(descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="stepsIgnoredFirefoxESR" select="count(/wet/testcase/testrun[@browser='FirefoxESR']/testfile/command[(descendant-or-self::ignored) and not(descendant::failure) and not(descendant::command/error)])"/>
                            <xsl:call-template name="testBrowserOverview">
                                <xsl:with-param name="browserPicture" select="$browserPicture.Firefox"/>
                                <xsl:with-param name="browserName">FF ESR</xsl:with-param>
                                <xsl:with-param name="browserTestFailureCount" select="$failedFirefoxESR"/>
                                <xsl:with-param name="browserTestErrorCount" select="$errorsFirefoxESR"/>
                                <xsl:with-param name="browserTestIgnoredCount" select="$ignoredFirefoxESR"/>
                                <xsl:with-param name="browserStepsOkCount" select="$stepsOkFirefoxESR"/>
                                <xsl:with-param name="browserStepsFailureCount" select="$stepsFailureFirefoxESR"/>
                                <xsl:with-param name="browserStepsErrorCount" select="$stepsErrorFirefoxESR"/>
                                <xsl:with-param name="browserStepsIgnoredCount" select="$stepsIgnoredFirefoxESR"/>
                            </xsl:call-template>
                        </table>
                    </xsl:if>
                    <xsl:if test="/wet/testcase/testrun/@browser='Chrome'">
                    ...
                    <xsl:if test="/wet/testcase/testrun/@browser='Edge'">
                        <table id="edgeoverview" class="overview" align="center" style="display: none; text-align: center;">
                            <xsl:variable name="failedEdge" select="count(/wet/testcase/testrun[@browser='Edge'][boolean(descendant::failure and not(error) and not(descendant::command/error) and not(descendant::testfile/error))])"/>
                            <xsl:variable name="errorsEdge" select="count(/wet/testcase/testrun[@browser='Edge'][boolean(error or descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="ignoredEdge" select="count(/wet/testcase/testrun[@browser='Edge']/ignored)"/>
                            <xsl:variable name="stepsOkEdge" select="count(/wet/testcase/testrun[@browser='Edge']/testfile/command[not(@isComment) and not(descendant-or-self::failure) and not(descendant-or-self::error) and not(descendant-or-self::ignored)])"/>
                            <xsl:variable name="stepsFailureEdge" select="count(/wet/testcase/testrun[@browser='Edge']/testfile/command[(descendant-or-self::failure) and not(descendant::command/error)])"/>
                            <xsl:variable name="stepsErrorEdge" select="count(/wet/testcase/testrun[@browser='Edge']/testfile[boolean(descendant-or-self::command/error or descendant::testfile/error)])"/>
                            <xsl:variable name="stepsIgnoredEdge" select="count(/wet/testcase/testrun[@browser='Edge']/testfile/command[(descendant-or-self::ignored) and not(descendant::failure) and not(descendant::command/error)])"/>
                            <xsl:call-template name="testBrowserOverview">
                                <xsl:with-param name="browserPicture" select="$browserPicture.Edge"/>
                                <xsl:with-param name="browserName">Edge</xsl:with-param>
                                <xsl:with-param name="browserTestFailureCount" select="$failedEdge"/>
                                <xsl:with-param name="browserTestErrorCount" select="$errorsEdge"/>
                                <xsl:with-param name="browserTestIgnoredCount" select="$ignoredEdge"/>
                                <xsl:with-param name="browserStepsOkCount" select="$stepsOkEdge"/>
                                <xsl:with-param name="browserStepsFailureCount" select="$stepsFailureEdge"/>
                                <xsl:with-param name="browserStepsErrorCount" select="$stepsErrorEdge"/>
                                <xsl:with-param name="browserStepsIgnoredCount" select="$stepsIgnoredEdge"/>
                            </xsl:call-template>
                        </table>
                    </xsl:if>
                </xsl:if>
